...
public class Operators {
    public static void main(String[] args) {
        ...
        //Sonuç 2'dir. Java sonuçları tamsayı olarak gösterir. Yuvarlama yapmadan noktadan sonrasını siler.


        int ogrenciSayisi=10;
        double ucret=35;
        System.out.println(ucret/ogrenciSayisi);
        // KURAL : BİR MATEMATİKSEL İŞLEMDE FARKLI DATA TİPİ KULLANIRSANIZ SONUÇ HER ZAMAN BÜYÜK DATA TİPİNDE OLUR
